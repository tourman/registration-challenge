import { keys } from 'entity/user/types';
import { State, StateValidator } from 'feature/registration/types';
...
const submitting: Validator = ({ submitting, display }) => {
...
const done: Validator = ({ display, validating }) => {
